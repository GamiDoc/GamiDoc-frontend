    ...
    <div>
      ...
      <div className="flex flex-row p-10 ">
        ...
        <div className="">
          ...
          <div id="context">
            <h1 className="font-bold">Context </h1>
            ...
            part related to the user context. <br /> <br />
          </div>
          <div id="domain">
            ...
            software for promoting environmental behaviors. <br /> <br />
          </div>
          <div id="aim">
          ...
          <div id="gamebehavior">
            ...
            game mechanics, game progression, and the game loop. <br /> <br />
          </div>{" "}
          <div id="gamerules">
          ...
          <div>
            <h1 className="font-bold">3.3 Game </h1>
          ...
          <div id="feedback">
            <h1 className="font-bold">3.5 Feedback </h1>
          ...
          <div id="personalization">
            <h1 className="font-bold">4 Personalization </h1>
          ...
          <div id="game">
            <h1 className="font-bold">5 Game </h1>
